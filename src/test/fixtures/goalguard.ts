...
export const fixtureCandidate: ProtectionCandidate = {
  ...
  premiumUsd: "2.5",
  quantityBaseUnits: "400000",
  quantityUnderlying: "0.4",
  maxPremiumLossUsd: "2.5",
  spotPriceUsd: "3000",
  requiredQuantityBaseUnits: "400000",
  effectiveBudgetUsd: "3",
  requiredFloorUsd: "1140",
  protectedFloorAtExpiryUsd: "1140",
  accessibleFloorByGoalDateUsd: null,
  expiryShortfallUsd: "0",
  goalDateShortfallUsd: null,
  protectionEndAt: "2099-09-30T08:00:00.000Z",
  settlementAvailableAt: null,
  settlementConfirmationAllowanceSeconds: null,
  settlementTrigger: "factory_callback",
  settlementTimingStatus: "settlement_timing_not_verified",
  accessibilityBasis: "unverified_factory_callback",
  timingAccessible: null,
  goalAttainment: "settlement_timing_not_verified",
  scoreVersion: "goal-protection-v1",
  protectionScore: null,
  scoreBreakdown: null,
  policyVersion: "goal-protection-policy-v1",
  expiryOverhangSeconds: 28800,
  settlementLeadSeconds: null,
  ...
  protocolRaw: {},
  scenarios: [
    { key: "down", settlementPriceUsd: "2200", underlyingValueUsd: "880", optionPayoffUsd: "262.5", premiumCostUsd: "2.5", netProtectedValueUsd: "1140" },
...
export const previewTradeResponse: PreviewTradeResponse = {
  data: {
    ...
    proposal: { premiumAmountBaseUnits: "2500000", quantityBaseUnits: "400000", coverageMode: "full", goalCoverageBps: 10000 },
    warnings: [],
  },
  meta: fixtureMeta,
};
