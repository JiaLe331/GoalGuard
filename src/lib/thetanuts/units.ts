...
/** Mirrors OptionBook.calculateNumContracts for USDC-settled orders. */
...
/** The SDK's put collateral formula: strike * contracts / 10^8. */
...
export function underlyingFromContractBaseUnits(value: bigint): Decimal {
  return decimalFromBaseUnits(value, USDC_DECIMALS);
}
